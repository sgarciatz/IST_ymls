 ...
 * returns List
 **/
exports.chatVoice_messageFilter_by_userGET = function(userId,secondUserId) {
 ...
 * returns String
 **/
exports.chatVoice_messagesBroadcastPOST = function(body) {
  return new Promise(function(resolve, reject) {
    var examples = {};
 ...
 * returns String
 **/
exports.chatVoice_messagesDELETE = function(voiceMessageId) {
  return new Promise(function(resolve, reject) {
    var examples = {};
 ...
 * returns List
 **/
exports.chatVoice_messagesFilter_by_contentGET = function(userId,filter) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
  "senderUserId" : 100,
 ...
 * returns List
 **/
exports.chatVoice_messagesGET = function(userId) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
  "senderUserId" : 100,
 ...
 * returns String
 **/
exports.chatVoice_messagesPOST = function(body) {
  return new Promise(function(resolve, reject) {
    var examples = {};
 ...
 * returns String
 **/
exports.chatVoice_messagesPUT = function(body,voiceMessageId) {
  return new Promise(function(resolve, reject) {
    var examples = {};
