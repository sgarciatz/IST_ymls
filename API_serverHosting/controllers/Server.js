...
module.exports.start_serverServerIdPUT = function start_serverServerIdPUT (req, res, next, serverId) {
  Server.start_serverServerIdPUT(serverId)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.stop_serverServerIdPUT = function stop_serverServerIdPUT (req, res, next, serverId) {
  Server.stop_serverServerIdPUT(serverId)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
